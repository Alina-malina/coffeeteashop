    <footer class="bg-brown">
        <div
            ...
            <div class="pt-50 col-md-3 text-start">
                <h3><a href="<?php echo e(route('categories')); ?>" alt="Главная" class="fst-normal fs-18 lh-22 fw-600 white">Категории</a></h3>
...
<?php /**PATH C:\OpenServer\domains\coffeetea_app\resources\views/layouts/footer.blade.php ENDPATH**/ ?>