                ...
                <div class="card-body p-4">
                    ...
                    <div class="row d-flex justify-content-between align-items-center ">                        
                        <div class="col-md-2 col-lg-2 col-xl-2">
                            ...
                            <img src="img_app/product/<?php echo e($product->image); ?>" class="img-fluid " alt="Товар <?php echo e($product->name); ?>"></a>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\coffeetea_app\resources\views/basket.blade.php ENDPATH**/ ?>