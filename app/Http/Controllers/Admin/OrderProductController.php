...
class OrderProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.order-product.index', compact('orderproduct'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/order-product')->with('flash_message', 'OrderProduct added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/order-product')->with('flash_message', 'OrderProduct updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/order-product')->with('flash_message', 'OrderProduct deleted!');
    }
}
