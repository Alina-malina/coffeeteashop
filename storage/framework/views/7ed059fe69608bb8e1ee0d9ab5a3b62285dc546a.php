...
<div class="form-group <?php echo e($errors->has('description2') ? 'has-error' : ''); ?>">
    <label for="description2" class="control-label"><?php echo e('Description2'); ?></label>
    <textarea class="form-control" rows="5" name="description2" type="textarea" id="description2" ><?php echo e(isset($product->description2) ? $product->description2 : ''); ?></textarea>
    <?php echo $errors->first('description2', '<p class="help-block">:message</p>'); ?>
...
<?php /**PATH C:\OpenServer\domains\coffeetea_app\resources\views/admin/products/form.blade.php ENDPATH**/ ?>